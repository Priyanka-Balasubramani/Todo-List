...
function App() {
  ...
  const activebuttonStyle = {
    backgroundColor: isCompleteScreen ? 'rgb(103, 93, 245)' : 'white',
  };
      ...
      <div className='My-ToDo'>
        <div className='todo-wrapper'>
          ...
          <div className='todo-button-area'>
            ...
            <button className={`isCompleteScreen ${isCompleteScreen === true && "active"}`} onClick={() => setIsCompleteScreen(true)} style={activebuttonStyle}>Completed</button>
          </div>
